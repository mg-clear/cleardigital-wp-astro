...
import 'clsx';
import { $ as $$Headline, a as $$CTAButton, b as $$Page } from './banner-blade_a7bc46cc.mjs';
import { $ as $$Image, a as $$HeroBanner } from './case-studies-detail_46a6af55.mjs';
/* empty css                                        *//* empty css                                        */
  ...
  return renderTemplate`${maybeRenderHead()}<div class="column swiper-slide" data-astro-cid-4kaut7jy>${() => {
    if (slideBackgroundVideoUrl) {
      ...
      return renderTemplate`${renderComponent($$result, "ImageTwoBlockBackgroundImage", $$ImageTwoBlockBackgroundImage, { "src": slideBackgroundImage.sourceUrl, "data-astro-cid-4kaut7jy": true })}`;
		...
		</h2> -->${renderComponent($$result, "Headline", $$Headline, { "tag": "h2", "content": slideHeadline, "typography": "h3", "theme": "light", "data-astro-cid-4kaut7jy": true })}${renderComponent($$result, "CTAButton", $$CTAButton, { "label": slideCtaText, "href": slideCtaUrl, "target": "_self", "style": "text", "class": "", "data-astro-cid-4kaut7jy": true })}</div></div>`;
...
const $$ImageTwoBlock = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!-- <section class="image-two-block blade dark">
    ...
    return renderTemplate`${renderComponent($$result, "ImageTwoBlockSlide", $$ImageTwoBlockSlide, { ...item, "data-astro-cid-roigbdzt": true })}`;
			...
			</div> --></div><div class="swiper-button-prev" data-cursor-expand data-cursor-icon="arrow-left" data-astro-cid-roigbdzt></div><div class="swiper-button-next" data-cursor-expand data-cursor-icon="arrow-right" data-astro-cid-roigbdzt></div></div></div>`;
