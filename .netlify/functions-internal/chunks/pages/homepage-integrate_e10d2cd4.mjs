...
import { a as $$HeroBanner } from './case-studies-detail_46a6af55.mjs';
import { $ as $$ImageTwoBlock, a as $$SliderWithContent } from './case-studies-overview_f89c3761.mjs';
...
const $$TwoGridSlider = createComponent(async ($$result, $$props, $$slots) => {
  ...
  })}</div><div class="swiper-pagination" data-astro-cid-zeaupek4></div><div class="swiper-button-prev" data-cursor-expand data-cursor-icon="arrow-left" data-astro-cid-zeaupek4></div><div class="swiper-button-next" data-cursor-expand data-cursor-icon="arrow-right" data-astro-cid-zeaupek4></div></div></div><div class="content content--logos row align-items-center mt-15 mt-lg-36" data-astro-cid-zeaupek4><div class="logos-heading" data-astro-cid-zeaupek4>${renderComponent($$result, "Headline", $$Headline, { "tag": featuredInGroup.headlineTag, "content": featuredInGroup.headline, "typography": featuredInGroup.headlineTypography, "data-astro-cid-zeaupek4": true })}</div><div class="logos" data-astro-cid-zeaupek4><ul class="logos-list" data-astro-cid-zeaupek4>${featuredInGroup.featuredInLogos.map((item) => {
